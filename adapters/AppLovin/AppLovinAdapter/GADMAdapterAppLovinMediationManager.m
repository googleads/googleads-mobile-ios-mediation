...
- (BOOL)containsAndAddInterstitialZoneIdentifier:(nonnull NSString *)zoneIdentifier {
  ...
  dispatch_sync(_lockQueue, ^{
    ...
    [GADMAdapterAppLovinUtils mutableSetAddObject:self->_requestedInterstitialZoneIdentifiers
...
- (void)removeInterstitialZoneIdentifier:(nonnull NSString *)zoneIdentifier {
  dispatch_async(_lockQueue, ^{
    [GADMAdapterAppLovinUtils mutableSetRemoveObject:self->_requestedInterstitialZoneIdentifiers
                                              object:zoneIdentifier];
  });
}
...
- (void)removeRewardedZoneIdentifier:(nonnull NSString *)zoneIdentifier {
  dispatch_async(_lockQueue, ^{
    [GADMAdapterAppLovinUtils mutableSetRemoveObject:self->_requestedRewardedZoneIdentifiers
                                              object:zoneIdentifier];
  });
}
...
- (BOOL)containsAndAddRewardedZoneIdentifier:(nonnull NSString *)zoneIdentifier {
  ...
  dispatch_sync(_lockQueue, ^{
    ...
    [GADMAdapterAppLovinUtils mutableSetAddObject:self->_requestedRewardedZoneIdentifiers
                                           object:zoneIdentifier];
  });
  return containsZone;
}
