...
public final class GADMAppLovinRewardedDelegate: NSObject, @preconcurrency ALAdLoadDelegate,
  ...
  @preconcurrency ALAdRewardDelegate
{
  ...
  /// Initializes a rewarded ad delegate with parent renderer to event delegation.
