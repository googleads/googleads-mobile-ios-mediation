...
@interface GADMWaterfallAppLovinBannerRenderer : NSObject <GADMediationBannerAd>
...
/// Loads an AppLovin banner ad. Expected to be called exactly once.
- (void)loadAdWithCompletion:(GADMediationBannerLoadCompletionHandler _Nonnull)completion;
