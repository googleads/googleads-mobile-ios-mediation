...
public class GADMAdapterAppLovinClientFactory: NSObject {
  ...
  @objc nonisolated(unsafe) public static var debugClient: GADMAdapterAppLovinClient?

  /// Creates and returns a client implementation.
  @objc public static func createClient() -> GADMAdapterAppLovinClient {
...
class GADMAdapterAppLovinClientImpl: NSObject, GADMAdapterAppLovinClient {
  func loadBannerAd(
