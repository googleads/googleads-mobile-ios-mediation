...
- DT Exchange SDK version 8.4.10.
...
- Verified compatibility with DT Exchange SDK version 8.4.7.

Built and tested with:
- Google Mobile Ads SDK version 13.3.0.
- DT Exchange SDK version 8.4.7.

#### [Version 8.4.6.0](https://dl.google.com/googleadmobadssdk/mediation/ios/dtexchange/DTExchangeAdapter-8.4.6.0.zip)
- Verified compatibility with DT Exchange SDK version 8.4.6.

Built and tested with:
- Google Mobile Ads SDK version 13.2.0.
- DT Exchange SDK version 8.4.6.

#### [Version 8.4.5.0](https://dl.google.com/googleadmobadssdk/mediation/ios/dtexchange/DTExchangeAdapter-8.4.5.0.zip)
- Verified compatibility with DT Exchange SDK version 8.4.5.
...
#### [Version 8.4.2.0](https://dl.google.com/googleadmobadssdk/mediation/ios/dtexchange/DTExchangeAdapter-8.4.2.0.zip)
- Verified compatibility with DT Exchange SDK version 8.4.2.

Built and tested with:
- Google Mobile Ads SDK version 12.14.0.
- DT Exchange SDK version 8.4.2.

#### [Version 8.4.1.0](https://dl.google.com/googleadmobadssdk/mediation/ios/dtexchange/DTExchangeAdapter-8.4.1.0.zip)
- Verified compatibility with DT Exchange SDK version 8.4.1.

Built and tested with:
- Google Mobile Ads SDK version 12.12.0.
- DT Exchange SDK version 8.4.1.

#### [Version 8.4.0.0](https://dl.google.com/googleadmobadssdk/mediation/ios/dtexchange/DTExchangeAdapter-8.4.0.0.zip)
- Verified compatibility with DT Exchange SDK version 8.4.0.
...
#### [Version 8.2.1.0](https://dl.google.com/googleadmobadssdk/mediation/ios/dtexchange/DTExchangeAdapter-8.2.1.0.zip)
