...
/// Initializes the native ad loader with the provided configuration and the load completion
/// handler.
///
/// @param adConfiguration native ad configuration.
/// @param completionHandler called by the adapter after loading the native ad or encountering
/// an error.
...
/// Loads a native ad and then calls the load completion handler provided in the initializer.
- (void)loadAd;
