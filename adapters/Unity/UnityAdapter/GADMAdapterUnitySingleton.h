...
- (BOOL)configureRewardBasedVideoAdWithGameID:(NSString *)gameID
                                delegate:
        (id<GADMAdapterUnityDataProvider, UnityAdsExtendedDelegate, UnityAdsBannerDelegate>) adapterDelegate;
...
- (void)stopTrackingDelegate: (id<GADMAdapterUnityDataProvider, UnityAdsExtendedDelegate>) adapterDelegate;
