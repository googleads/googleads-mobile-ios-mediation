...
@interface GADMAdapterMintegralRTBRewardedAdLoader ()<MTGRewardAdLoadDelegate,MTGRewardAdShowDelegate>
...
- (void)loadRTBRewardedAdForAdConfiguration:(nonnull GADMediationRewardedAdConfiguration *)adConfiguration
...
- (void)presentFromViewController:(nonnull UIViewController *)viewController {
    ...
    if ([_rewardedAd isVideoReadyToPlayWithPlacementId:_placementId unitId:_adUnitId]) {
        ...
        NSError *error =
        GADMAdapterMintegralErrorWithCodeAndDescription(GADMintegralErrorAdFailedToShow, @"Mintegral SDK failed to present a bidding rewarded video ad.");
        [_adEventDelegate didFailToPresentWithError:error];
    }
}
