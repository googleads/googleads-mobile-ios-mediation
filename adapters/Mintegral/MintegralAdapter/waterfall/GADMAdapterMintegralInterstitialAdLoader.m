...
- (void)loadInterstitialAdForAdConfiguration:(nonnull GADMediationInterstitialAdConfiguration *)adConfiguration completionHandler:(nonnull GADMediationInterstitialLoadCompletionHandler)
    ...
    _interstitialAd = [[MTGNewInterstitialAdManager alloc]initWithPlacementId:placementId unitId:adUnitId delegate:self];
...
- (void)presentFromViewController:(nonnull UIViewController *)viewController {
    ...
    if ([_interstitialAd isAdReady]) {
        ...
        NSError *error =
        GADMAdapterMintegralErrorWithCodeAndDescription(GADMintegralErrorAdFailedToShow, @"Mintegral SDK failed to present a waterfall interstitial ad.");
        [_adEventDelegate didFailToPresentWithError:error];
    }
}
