...
#### [Version 8.1.7.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-8.1.7.0.zip)
...
Built and tested with:
- Google Mobile Ads SDK version 13.7.0.
- Mintegral SDK version 8.1.6.

#### [Version 8.1.5.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-8.1.5.0.zip)
- Verified compatibility with Mintegral SDK version 8.1.5.
...
- Mintegral SDK version 8.1.5.

#### [Version 8.1.4.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-8.1.4.0.zip)
- Verified compatibility with Mintegral SDK version 8.1.4.

Built and tested with:
- Google Mobile Ads SDK version 13.4.0.
- Mintegral SDK version 8.1.4.
...
#### [Version 8.1.1.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-8.1.1.0.zip)
- Verified compatibility with Mintegral SDK version 8.1.1.

Built and tested with:
- Google Mobile Ads SDK version 13.2.0.
- Mintegral SDK version 8.1.1.

#### [Version 8.0.9.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-8.0.9.0.zip)
- Verified compatibility with Mintegral SDK version 8.0.9.

Built and tested with:
- Google Mobile Ads SDK version 13.2.0.
- Mintegral SDK version 8.0.9.

#### [Version 8.0.8.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-8.0.8.0.zip)
- Verified compatibility with Mintegral SDK version 8.0.8.

Built and tested with:
- Google Mobile Ads SDK version 13.1.0.
- Mintegral SDK version 8.0.8.

#### [Version 8.0.7.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-8.0.7.0.zip)
- Verified compatibility with Mintegral SDK version 8.0.7.
- Updated the Google Mobile Ads SDK dependency to version 13.0.0.

Built and tested with:
- Google Mobile Ads SDK version 13.0.0.
- Mintegral SDK version 8.0.7.
...
#### [Version 8.0.4.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-8.0.4.0.zip)
- Verified compatibility with Mintegral SDK version 8.0.4.

Built and tested with:
- Google Mobile Ads SDK version 12.14.0.
- Mintegral SDK version 8.0.4.

#### [Version 8.0.3.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-8.0.3.0.zip)
- Verified compatibility with Mintegral SDK version 8.0.3.

Built and tested with:
- Google Mobile Ads SDK version 12.13.0.
- Mintegral SDK version 8.0.3.
...
- Mintegral SDK version 7.7.7.

#### [Version 7.7.6.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-7.7.6.0.zip)
- Verified compatibility with Mintegral SDK version 7.7.6.

Built and tested with:
- Google Mobile Ads SDK version 12.0.0.
- Mintegral SDK version 7.7.6.

#### [Version 7.7.5.1](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-7.7.5.1.zip)
- Now requires Google Mobile Ads SDK version 12.0.0 or higher.

Built and tested with:
- Google Mobile Ads SDK version 12.0.0.
- Mintegral SDK version 7.7.5.
...
#### [Version 7.7.4.0](https://dl.google.com/googleadmobadssdk/mediation/ios/mintegral/MintegralAdapter-7.7.4.0.zip)
- Verified compatibility with Mintegral SDK version 7.7.4.
- Updated the adapter to follow Google's Objective-C best practices.

Built and tested with:
- Google Mobile Ads SDK version 11.13.0.
- Mintegral SDK version 7.7.4.
