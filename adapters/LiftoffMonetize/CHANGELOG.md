...
- Vungle SDK version 7.7.5.

#### [Version 7.7.4.0](https://dl.google.com/googleadmobadssdk/mediation/ios/liftoffmonetize/LiftoffMonetizeAdapter-7.7.4.0.zip)
...
#### [Version 7.7.3.0](https://dl.google.com/googleadmobadssdk/mediation/ios/liftoffmonetize/LiftoffMonetizeAdapter-7.7.3.0.zip)
...
- Added setting of `adapterAdFormat` property introduced in Vungle SDK version 7.7.1.
...
#### [Version 7.7.1.0](https://dl.google.com/googleadmobadssdk/mediation/ios/liftoffmonetize/LiftoffMonetizeAdapter-7.7.1.0.zip)
...
#### [Version 7.7.0.0](https://dl.google.com/googleadmobadssdk/mediation/ios/liftoffmonetize/LiftoffMonetizeAdapter-7.7.0.0.zip)
- Verified compatibility with Vungle SDK 7.7.0.
- Updated the Google Mobile Ads SDK dependency to version 13.0.0 and up.
- Increased the minimum iOS deployment target to `13.0`.
- Added support for native video options and media view delegate callbacks.

Built and tested with:
- Google Mobile Ads SDK version 13.0.0.
- Vungle SDK version 7.7.0.

#### [Version 7.6.3.2](https://dl.google.com/googleadmobadssdk/mediation/ios/liftoffmonetize/LiftoffMonetizeAdapter-7.6.3.2.zip)
...
#### [Version 7.6.2.0](https://dl.google.com/googleadmobadssdk/mediation/ios/liftoffmonetize/LiftoffMonetizeAdapter-7.6.2.0.zip)
...
#### [Version 7.6.1.0](https://dl.google.com/googleadmobadssdk/mediation/ios/liftoffmonetize/LiftoffMonetizeAdapter-7.6.1.0.zip)
...
#### [Version 7.6.0.0](https://dl.google.com/googleadmobadssdk/mediation/ios/liftoffmonetize/LiftoffMonetizeAdapter-7.6.0.0.zip)
...
#### [Version 7.5.1.0](https://dl.google.com/googleadmobadssdk/mediation/ios/liftoffmonetize/LiftoffMonetizeAdapter-7.5.1.0.zip)
...
#### [Version 7.5.0.0](https://dl.google.com/googleadmobadssdk/mediation/ios/liftoffmonetize/LiftoffMonetizeAdapter-7.5.0.0.zip)
