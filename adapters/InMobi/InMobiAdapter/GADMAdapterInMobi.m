...
- (void)prepareRequestParameters {
    ...
    if (extraInfo != nil) {
        ...
        if(extraInfo.loginId!=nil)
            [IMSdk addId:extraInfo.loginId forType:kIMSDKIdTypeLogin];
        if(extraInfo.sessionId!=nil)
            [IMSdk addId:extraInfo.sessionId forType:kIMSDKIdTypeSession];
