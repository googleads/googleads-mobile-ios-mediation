...
- (void)onLoadWithNativePromoBanner:(MTRGNativePromoBanner *)promoBanner nativeAd:(MTRGNativeAd *)nativeAd
{
	...
	_mediatedNativeAd = [GADMAdapterMyTargetMediatedNativeAd mediatedNativeAdWithNativePromoBanner:promoBanner delegate:self autoLoadImages:_autoLoadImages mediaAdView:_mediaAdView];
