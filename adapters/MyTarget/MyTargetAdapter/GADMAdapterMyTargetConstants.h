...
static NSString *const kGADMAdapterMyTargetErrorDomain = @"com.my.target.sdk.mediation.admob.errorDomain";
...
static NSString *const kGADMAdapterMyTargetErrorMediatedAdInvalid = @"Some of the Always Included assets are not available for the ad";
static NSString *const kGADMAdapterMyTargetErrorMediatedAdDoesNotMatch = @"Mediated NativeAd [%@] doesn't match reqeusted type (%@)";
static NSString *const kGADMAdapterMyTargetErrorBannersNotSupported = @"Banners are not supported by this adapter";
static NSString *const kGADMAdapterMyTargetErrorInterstitialNotSupported = @"Interstitial ads are not supported by this adapter";
