...
/// Delegate for listening to notifications from Meta Audience Network.
@interface GADFBAdapterDelegate : NSObject <FBAdViewDelegate, FBRewardedVideoAdDelegate>

/// Meta Audience Network banner views can have flexible width. Set this property to the desired
