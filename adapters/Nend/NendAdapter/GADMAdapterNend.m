...
@interface GADMAdapterNend () <NADViewDelegate, NADInterstitialDelegate, NADInterstitialVideoDelegate>
...
- (void)presentInterstitialFromRootViewController:(UIViewController *)rootViewController {
    if (self.interstitialType == GADMNendInterstitialTypeVideo) {
        ...
        NADInterstitialShowResult result = [self.interstitial showAdFromViewController:rootViewController];
...
- (void)nadViewDidReceiveAd:(NADView *)adView {
    ...
    if ((self.selectedAdSize.height != adView.frame.size.height) || (self.selectedAdSize.width != adView.frame.size.width)) {
    ...
    switch (type) {
        ...
        case CLOSE:
            if ([UIApplication sharedApplication].applicationState == UIApplicationStateActive) {
                ...
                [self.notificationCenter addObserver:self selector:@selector(willEnterForeground:) name:UIApplicationWillEnterForegroundNotification object:nil];
            }
            break;
        default:
            break;
