...
@interface GADMAdapterIronSourceRtbInterstitialAd : NSObject <GADMediationInterstitialAd,
...
@property(weak, nonatomic)
    id<GADMediationInterstitialAdEventDelegate> _Nullable interstitialAdEventDelegate;
