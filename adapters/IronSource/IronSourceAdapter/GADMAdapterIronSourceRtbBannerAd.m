...
(GADMediationBannerLoadCompletionHandler)completionHandler{
    ...
    ISAAdSize *iAdsBannerSize = [GADMAdapterIronSourceUtils iAdsSizeFromRequestedSize:adConfiguration.adSize];
    ISABannerAdRequestBuilder *requestBuilder = [[[ISABannerAdRequestBuilder alloc] initWithInstanceId:self.instanceID adm:bidResponse size:iAdsBannerSize]withExtraParams:extraParams];
    
    ISABannerAdRequest *adRequest = [[requestBuilder withViewController: adConfiguration.topViewController] build];
