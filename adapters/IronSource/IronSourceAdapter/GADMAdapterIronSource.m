...
- (void)getInterstitial {
    ...
    [sharedManager requestInterstitialAdWithDelegate:self instanceID: self.instanceID];
}

- (void)presentInterstitialFromRootViewController:(UIViewController *)rootViewController {
    [GADMAdapterIronSourceUtils onLog:[NSString stringWithFormat:@"Present IronSource interstitial ad for instance %@",
                                       self.instanceID]];
...
- (void)interstitialDidLoad:(NSString *)instanceId {
    [GADMAdapterIronSourceUtils onLog:[NSString stringWithFormat:@"IronSource interstitial ad did load for instance %@",
                                       instanceId]];
...
- (void)interstitialDidOpen:(NSString *)instanceId {
    [GADMAdapterIronSourceUtils onLog:[NSString stringWithFormat:@"IronSource interstitial ad did open for instance %@",
                                       instanceId]];
    id<GADMAdNetworkConnector> strongConnector = _interstitialConnector;
...
- (void)interstitialDidClose:(NSString *)instanceId {
    [GADMAdapterIronSourceUtils onLog:[NSString stringWithFormat:@"IronSource interstitial ad did close for instance %@",
                                       instanceId]];
...
- (void)interstitialDidShow:(NSString *)instanceId {
    [GADMAdapterIronSourceUtils onLog:[NSString stringWithFormat:@"IronSource interstitial ad did show for instance %@",
                                       instanceId]];
}
...
- (void)interstitialDidFailToShowWithError:(NSError *)error instanceId:(NSString *)instanceId {
    [GADMAdapterIronSourceUtils onLog:[NSString stringWithFormat:@"IronSource interstitial ad did fail to show with error "
                                       @"%@, for instance: %@",
                                       error.localizedDescription, instanceId]];
...
- (void)didClickInterstitial:(NSString *)instanceId {
    [GADMAdapterIronSourceUtils onLog:[NSString stringWithFormat:@"Did click IronSource interstitial ad for instance %@",
                                       instanceId]];
...
- (void)setState:(NSString *)state {
    [GADMAdapterIronSourceUtils onLog:[NSString stringWithFormat:@"IS Instance setState: changing from oldState=%@ to newState=%@", self.instanceState, state]];
