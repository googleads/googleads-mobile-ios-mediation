...
- (void)testLoadSuccessIfChildTagIsNilAndUnderAgeTagIsFalse {
  GADMobileAds.sharedInstance.requestConfiguration.tagForChildDirectedTreatment = nil;
...
- (void)testLoadFailureIfChildTagIsNilAndUnderAgeTagIsTrue {
  GADMobileAds.sharedInstance.requestConfiguration.tagForChildDirectedTreatment = nil;
...
- (void)testLoadSuccessIfChildTagIsFalseAndUnderAgeTagIsNil {
...
- (void)testLoadFailureIfChildTagIsFalseAndUnderAgeTagIsTrue {
  GADMobileAds.sharedInstance.requestConfiguration.tagForChildDirectedTreatment = @NO;
  GADMobileAds.sharedInstance.requestConfiguration.tagForUnderAgeOfConsent = @YES;
  AUTKMediationBannerAdConfiguration *config = [[AUTKMediationBannerAdConfiguration alloc] init];
...
- (void)testLoadFailureIfChildTagIsTrueAndUnderAgeTagIsNil {
...
- (void)testLoadFailureIfChildTagIsTrueAndUnderAgeTagIsFalse {
  GADMobileAds.sharedInstance.requestConfiguration.tagForChildDirectedTreatment = @YES;
  GADMobileAds.sharedInstance.requestConfiguration.tagForUnderAgeOfConsent = @NO;
  AUTKMediationBannerAdConfiguration *config = [[AUTKMediationBannerAdConfiguration alloc] init];
...
- (void)testGetView {
  AUTKMediationBannerAdEventDelegate *eventDelegate = [self loadAdAndAssertLoadSuccess];
...
- (void)testAdDisplayed {
  AUTKMediationBannerAdEventDelegate *delegate = [self loadAdAndAssertLoadSuccess];

  [_appLovinDelegate ad:_adMock wasDisplayedIn:_appLovinAdViewMock];
...
- (void)testAdClick {
  ...
  [_appLovinDelegate ad:_adMock wasClickedIn:_appLovinAdViewMock];
...
- (void)testDidPresentFullscreen {
  ...
  [_appLovinDelegate ad:_adMock didPresentFullscreenForAdView:_appLovinAdViewMock];
...
- (void)testWillDismissFullscreen {
  ...
  [_appLovinDelegate ad:_adMock willDismissFullscreenForAdView:_appLovinAdViewMock];
...
- (void)testDidDismissFullscreen {
  ...
  [_appLovinDelegate ad:_adMock didDismissFullscreenForAdView:_appLovinAdViewMock];
...
- (void)testUnhandledEventsResultInNoCrash {
  ...
  [_appLovinDelegate ad:_adMock wasHiddenIn:_appLovinAdViewMock];
  [_appLovinDelegate ad:_adMock willLeaveApplicationForAdView:_appLovinAdViewMock];
}
