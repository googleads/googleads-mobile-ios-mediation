...
public class FakeAppLovinClient: NSObject, AppLovinClient {
  ...
  @objc public weak var delegate: (ALAdLoadDelegate & ALAdDisplayDelegate & ALAdViewEventDelegate)?
  ...
  @objc public func loadBannerAd(
    ...
    if shouldTriggerLoadSuccess {
      if let ad = mockAdToLoad {
        delegate.adService(sdk.adService, didLoadAd: ad)
      }
