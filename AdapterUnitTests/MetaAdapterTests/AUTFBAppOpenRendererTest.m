...
- (void)testSetMixedAudienceYESWhenChildDirectedIsTrue {
...
- (void)testSetMixedAudienceYESWhenUnderAgeOfConsentIsTrue {
...
- (void)testSetMixedAudienceYESWhenChildDirectedIsTrueAndUnderAgeIsFalse {
  GADMobileAds.sharedInstance.requestConfiguration.tagForChildDirectedTreatment = @YES;
...
- (void)testSetMixedAudienceYESWhenChildDirectedIsFalseAndUnderAgeIsTrue {
...
- (void)testSetMixedAudienceNOWhenBothAreTrue {
  GADMobileAds.sharedInstance.requestConfiguration.tagForChildDirectedTreatment = @YES;
  GADMobileAds.sharedInstance.requestConfiguration.tagForUnderAgeOfConsent = @YES;
  OCMExpect([_fbAdSettingsMock setMixedAudience:YES]);
...
- (void)testSetMixedAudienceNOWhenBothAreFalse {
  GADMobileAds.sharedInstance.requestConfiguration.tagForChildDirectedTreatment = @NO;
  GADMobileAds.sharedInstance.requestConfiguration.tagForUnderAgeOfConsent = @NO;
...
- (void)testSetMixedAudienceNOWhenChildDirectedIsFalseAndUnderAgeIsNil {
  GADMobileAds.sharedInstance.requestConfiguration.tagForChildDirectedTreatment = @NO;
  OCMExpect([_fbAdSettingsMock setMixedAudience:NO]);
...
- (void)testSetMixedAudienceNOWhenUnderAgeIsFalseAndChildDirectedIsNil {
  GADMobileAds.sharedInstance.requestConfiguration.tagForUnderAgeOfConsent = @NO;
  OCMExpect([_fbAdSettingsMock setMixedAudience:NO]);
