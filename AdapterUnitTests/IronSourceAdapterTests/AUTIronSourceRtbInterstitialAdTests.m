...
- (void)setUp {
  ...
  self.mockInterstitialAdEventDelegate =
...
- (void)testInterstitialAdDidLoad {
  ...
  GADMediationInterstitialLoadCompletionHandler completionHandler =
      ^id<GADMediationInterstitialAdEventDelegate>(id<GADMediationInterstitialAd> ad,
                                                   NSError *error) {
    XCTAssertNotNil(ad);
    XCTAssertNil(error);
    return nil;
  ...
  // Verify the behavior
  XCTAssertEqual(self.adapter.biddingISAInterstitialAd, self.mockInterstitialAd,
                 @"The Interstitial ad should be set correctly.");
}
...
- (void)testInterstitialAdDidLoadWithoutLoadCompletionHandler {
  ...
  // Then
  XCTAssertEqual(self.adapter.interstitalAdLoadCompletionHandler, nil,
                 @"The Interstitial ad should be nil.");
}
...
- (void)testInterstitialAdDidFailToLoadWithError {
  ...
  GADMediationInterstitialLoadCompletionHandler mockCompletionHandler =
      ^id<GADMediationInterstitialAdEventDelegate>(id<GADMediationInterstitialAd> ad,
                                                   NSError *error) {
    // Then
    XCTAssertNil(ad);
