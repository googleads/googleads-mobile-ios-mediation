#import "AUTKMediationRewardedInterstitialAdLoadAssertions.h"
...
AUTKMediationRewardedAdEventDelegate *AUTKWaitAndAssertLoadRewardedInterstitialAd(
  ...
  XCTestExpectation *expectation =
      [[XCTestExpectation alloc] initWithDescription:@"Load a rewarded interstitial ad."];
  ...
  [adapter loadRewardedInterstitialAdForAdConfiguration:configuration
...
void AUTKWaitAndAssertLoadRewardedInterstitialAdFailure(
    id<GADMediationAdapter> adapter, GADMediationRewardedAdConfiguration *configuration,
    NSError *expectedError) {
  XCTestExpectation *expectation =
      [[XCTestExpectation alloc] initWithDescription:@"Fail to load a rewarded interstitial ad."];
