...
@interface AUTLiftoffMonetizeRTBRewardedAdTests : XCTestCase

@end

@implementation AUTLiftoffMonetizeRTBRewardedAdTests {
...
- (void)testLoadRewardedSuccessWhenLiftoffSdkIsInitialized {
  ...
  [self loadRewardedAndAssertLoadSuccessWithCredentials:credentials andExtras:nil];
}
...
- (AUTKMediationRewardedAdEventDelegate *)loadRewardedAndGetEventDelegate {
  ...
  AUTKMediationCredentials *credentials = [[AUTKMediationCredentials alloc] init];
  credentials.settings = @{GADMAdapterVunglePlacementID : kPlacementID};
  return [self loadRewardedAndAssertLoadSuccessWithCredentials:credentials andExtras:nil];
}
